...
class Featurize(StandardWorkflowComponent):
    ...
    def setup(self, workflow, input_feeds):
        if 'tokenized' in input_feeds.keys():
            featurizertask = workflow.new_task('FeaturizerTask_tokens', Tokenized2Features, ngrams=self.ngrams, blackfeats=self.blackfeats, lowercase=self.lowercase, minimum_token_frequency=self.minimum_token_frequency, autopass=True)
            featurizertask.in_tokenized = input_feeds['tokenized']

        elif 'frogged' in input_feeds.keys():
            featurizertask = workflow.new_task('FeaturizerTask_frogged', Frog2Features, featuretypes=self.featuretypes, ngrams=self.ngrams, blackfeats=self.blackfeats, lowercase=self.lowercase, minimum_token_frequency=self.minimum_token_frequency,autopass=True)
            ...
            if self.tokconfig:
                ...
                featurizertask = workflow.new_task('FeaturizerTask_txt', Tokenized2Features, ngrams=self.ngrams, blackfeats=self.blackfeats, lowercase=self.lowercase, minimum_token_frequency=self.minimum_token_frequency, autopass=True)
                ...
                featurizertask = workflow.new_task('FeaturizerTask_txt', Frog2Features, featuretypes=self.featuretypes, ngrams=self.ngrams, blackfeats=self.blackfeats, lowercase=self.lowercase, minimum_token_frequency=self.minimum_token_frequency, autopass=True)
            ...
            if self.tokconfig:
                ...
                featurizertask = workflow.new_task('FeaturizerTask_txtdir', Tokdir2Features, ngrams=self.ngrams, blackfeats=self.blackfeats, lowercase=self.lowercase, minimum_token_frequency=self.minimum_token_frequency, autopass=True)
                ...
                featurizertask = workflow.new_task('FeaturizerTask_txtdir', Frogdir2Features, featuretypes=self.featuretypes, ngrams=self.ngrams, blackfeats=self.blackfeats, lowercase=self.lowercase, minimum_token_frequency=self.minimum_token_frequency, autopass=True)
