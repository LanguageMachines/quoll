...
class VectorizeTrainTest(WorkflowComponent):
    ...
    def accepts(self):
        return  [ 
            ...
            ( InputFormat(self, format_id='pre_featurized_train',extension='.frog.json' or '.tok.txt',inputparameter='traininstances'), InputFormat(self, format_id='labels_train',extension='.labels',inputparameter='trainlabels'), InputFormat(self, format_id='pre_featurized_test',extension='.tok.txt' or '.frog.json',inputparameter='testinstances') ) 
