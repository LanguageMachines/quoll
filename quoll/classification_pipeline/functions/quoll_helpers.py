...
def prepare_classify_input(kwargs):
    return '--'.join([str(x) for x in [
        kwargs['classifier'],kwargs['ensemble'],kwargs['ordinal'],kwargs['jobs'],kwargs['iterations'],kwargs['scoring'],kwargs['linear_raw'],kwargs['scale'],kwargs['min_scale'],kwargs['max_scale'],
        kwargs['random_clf'],
...
def decode_classify_input(paramstring):
    return dict(zip(['classifier','ensemble','ordinal','jobs','iterations','scoring','linear_raw','scale','min_scale','max_scale','random_clf','nb_alpha','nb_fit_prior','svm_c','svm_kernel','svm_gamma','svm_degree','svm_class_weight',
...
def set_parameter_types(parameterdict):
    type_dict = {
        ...
        'ensemble':'bool','ordinal':'bool','jobs':'int','iterations':'int','linear_raw':'bool','scale':'bool',
