...
setup(
    ...
    packages=['quoll','quoll.classification_pipeline', 'quoll.classification_pipeline.functions', 'quoll.classification_pipeline.modules', 'quoll.lsa_pipeline', 'quoll.lsa_pipeline.functions', 'quoll.lsa_pipeline.modules'],
    ...
    install_requires=['LuigiNLP','pynlpl','gensim','scikit-learn','numpy','scipy','colibri-core'],
